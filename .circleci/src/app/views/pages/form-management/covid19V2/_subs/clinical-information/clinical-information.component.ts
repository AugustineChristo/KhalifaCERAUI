...
export class covid19V2ClinicalInformationComponent implements OnInit {
  form:FormGroup;
  title:string = "Clinical Information";
...
"BloodType": new FormControl({value: '', disabled: this.disableInput}),
"BloodTypePositiveNegative": new FormControl({value: '', disabled: this.disableInput}),
"ParticipantsWeight": new FormControl({value: '', disabled: this.disableInput}),
"ParticipantsHeight": new FormControl({value: '', disabled: this.disableInput}),
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(13,4).subscribe((res)=> {
