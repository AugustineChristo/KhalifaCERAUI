...
export class covid19V2PrintComponent implements OnInit,OnDestroy {
  ...
  @ViewChild('appcovid19V2PersonalDetails')appcovid19V2PersonalDetails: covid19V2PersonalDetailsComponent;
	
	@ViewChild('appcovid19V2ClinicalDetails')appcovid19V2ClinicalDetails: covid19V2ClinicalDetailsComponent;
	@ViewChild('appcovid19V2ClinicalInformation')appcovid19V2ClinicalInformation: covid19V2ClinicalInformationComponent;
	
	@ViewChild('appcovid19V2ClinicalOutcome')appcovid19V2ClinicalOutcome: covid19V2ClinicalOutcomeComponent;
	@ViewChild('appcovid19V2DFIFFQ')appcovid19V2DFIFFQ: covid19V2DFIFFQComponent;
	@ViewChild('appcovid19V2Treatmentregimen')appcovid19V2Treatmentregimen: covid19V2TreatmentregimenComponent;
