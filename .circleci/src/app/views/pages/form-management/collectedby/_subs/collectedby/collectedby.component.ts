...
@Component({
  selector: 'kt-collectedbysub',
  templateUrl: './collectedby.component.html'
})
export class CollectedBySubComponent implements OnInit {
 form: FormGroup;
  ...
  createForm() {
    this.form = this.eformFB.group({
      ...
      "name": new FormControl({value: '', disabled: this.disableInput},[Validators.required,Validators.maxLength(200)]),
    });
...
createSampleId(){
  ...
  this._service.createSampleId(21,this.form.value["name"]).subscribe((res)=> {
      this.saveFormId = res;
      this.splashService.splashScreen({isLoading : false, message : "" })
