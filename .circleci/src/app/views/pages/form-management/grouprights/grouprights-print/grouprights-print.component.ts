...
import { grouprightsPersonalDetailsComponent } from '../_subs/personal-details/personal-details.component';


@Component({
  selector: 'kt-grouprights-print',
  templateUrl: './grouprights-print.component.html'
})
export class grouprightsPrintComponent implements OnInit,OnDestroy {
