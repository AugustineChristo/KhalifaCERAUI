...
import { HsaUrinetestsummaryComponent } from '../_subs/urinetestsummary/urinetestsummary.component';
@Component({
...
export class HsaEditComponent implements OnInit, OnDestroy {
    ...
    @ViewChild('appHsaPersonalDetails')appHsaPersonalDetails: HsaPersonalDetailsComponent;
	@ViewChild('appHsaLifeStyleDetails')appHsaLifeStyleDetails: HsaLifestyleDetailsComponent;
	@ViewChild('appHsaFamilyHistory')appHsaFamilyHistory: HsaFamilyHistoryComponent;
	@ViewChild('appHsaFamilyPedigree')appHsaFamilyPedigree: HsaFamilyPedigreeComponent;
	@ViewChild('appHsaMedicalHistory')appHsaMedicalHistory: HsaMedicalHistoryComponent;
	@ViewChild('appHsaMedicalDetails')appHsaMedicalDetails: HsaMedicalDetailsComponent;
	@ViewChild('appHsaDiabetesSelfManagement')appHsaDiabetesSelfManagement: HsaDiabetesSelfManagementComponent;
	@ViewChild('appHsaPhysicalMeasurements')appHsaPhysicalMeasurements: HsaPhysicalMeasurementsComponent;
	@ViewChild('appHsaClinicalDetails')appHsaClinicalDetails: HsaClinicalDetailsComponent;
	@ViewChild('appHsaMedicationDetails')appHsaMedicationDetails: HsaMedicationComponent;
	@ViewChild('appHsaUrinetestsummary')appHsaUrinetestsummary: HsaUrinetestsummaryComponent;
	@ViewChild('appHsaBiochemical')appHsaBiochemical: HsaBiochemicalComponent;
	@ViewChild('appHsaCognitiveTestResult')appHsaCognitiveTestResult: HsaCognitiveTestResultComponent;
    @ViewChild('appHsaLaboratoryDetails')appHsaLaboratoryDetails: HsaLaboratoryDetailsComponent;
   ...
   // else if(this.selectedTab == 8){
	...
	//	 }
			...
			this.appHsaBiochemical.onSubmit();
				...
				this.appHsaUrinetestsummary.onSubmit();
			}
