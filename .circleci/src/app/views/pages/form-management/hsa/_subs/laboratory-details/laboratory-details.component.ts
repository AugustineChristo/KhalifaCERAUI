...
@Component({
  selector: 'kt-hsa-laboratory-details',
  templateUrl: './laboratory-details.component.html'
})
export class HsaLaboratoryDetailsComponent implements OnInit {
  form:FormGroup;
  ...
  createForm() {
    this.form = this.eformFB.group({
      ...
      "lab_saliva": new FormControl({value: '', disabled: this.disableInput}),
      "lab_tissue": new FormControl({value: '', disabled: this.disableInput}),
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(10,9).subscribe((res)=> {
