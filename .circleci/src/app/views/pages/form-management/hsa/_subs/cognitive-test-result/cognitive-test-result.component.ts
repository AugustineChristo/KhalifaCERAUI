...
@Component({
  selector: 'kt-hsa-cognitive-test-result',
  templateUrl: './cognitive-test-result.component.html'
})

export class HsaCognitiveTestResultComponent implements OnInit {
  Mform:FormGroup;
  ...
  createForm() {
    this.Mform = this.eformFB.group({
      ...
      "Cognitive_test_result_time": new FormControl({value: '', disabled: this.disableInput}),
    })
    this.getFormAttributeValues();
  }

  getFormAttributeValues() {
    this._service.getFormAttribute(10,8).subscribe((res)=> {
