...
export class NewLaboratoryDetailsComponent implements OnInit {
  form:FormGroup;
  ...
  createForm() {
    this.form = this.eformFB.group({
      ...
      "lab_sample_type_tissue": new FormControl({value: '', disabled: this.disableInput}),
      "lab_sample_type_other": new FormControl({value: '', disabled: this.disableInput}),
      "lab_sample_type_other_text": new FormControl({value: '', disabled: this.disableInput}),
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(9,11).subscribe((res)=> {
