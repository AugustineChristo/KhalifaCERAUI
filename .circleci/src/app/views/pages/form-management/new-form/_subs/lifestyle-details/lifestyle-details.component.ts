...
export class NewLifestyleDetailsComponent implements OnInit {
  Mform:FormGroup;
  title:string = "Lifestyle Details";
  ...
  createForm() {
    this.Mform = this.eformFB.group({
      ...
      "Walk_IfYes": new FormControl({value: '', disabled: this.disableInput}),
      "Walk_others_Specify": new FormControl({value: '', disabled: this.disableInput}),
      "walking_intensity": new FormControl({value: '', disabled: this.disableInput}),
      "healthy_diet": new FormControl({value: '', disabled: this.disableInput}),
      "diet_other": new FormControl({value: '', disabled: this.disableInput}),
      "weight_change": new FormControl({value: '', disabled: this.disableInput}),
      "spl_diet": new FormControl({value: '', disabled: this.disableInput}),
      "fastfood_intake": new FormControl({value: '', disabled: this.disableInput}),
      "fruits_veg": new FormControl({value: '', disabled: this.disableInput}),
      "softdrinks": new FormControl({value: '', disabled: this.disableInput}),
      "eat_after_midnight": new FormControl({value: '', disabled: this.disableInput}),
      "satisfied_body": new FormControl({value: '', disabled: this.disableInput}),
      "happy_life": new FormControl({value: '', disabled: this.disableInput}),
      "healthy_individual": new FormControl({value: '', disabled: this.disableInput}),
    })
    this.getFormAttributeValues();
  }

  getFormAttributeValues() {
    this._service.getFormAttribute(9,8).subscribe((res)=> {
