...
export class NewFamilyPedigreeComponent implements OnInit {
  Mform:FormGroup;
  ...
  createForm() {
    this.Mform = this.eformFB.group({
      ...
      "fam_pedigree": new FormControl({value: '', disabled: this.disableInput}),
    })
    this.getFormAttributeValues();
  }

  getFormAttributeValues() {
    this._service.getFormAttribute(9,10).subscribe((res)=> {
