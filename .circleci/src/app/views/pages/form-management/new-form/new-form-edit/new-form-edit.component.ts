...
export class NewFormEditComponent implements OnInit, OnDestroy {
    ...
    @ViewChild('appNewFamilyInformation')appNewFamilyInformation: NewFamilyInformationComponent;
	@ViewChild('appNewBiochemical')appNewBiochemical: NewBiochemicalComponent;
	@ViewChild('appNewFamilyPedigree')appNewFamilyPedigree: NewFamilyPedigreeComponent;
	@ViewChild('appNewLaboratoryDetails')appNewLaboratoryDetails: NewLaboratoryDetailsComponent;
	@ViewChild('appNewLifestyleDetails')appNewLifestyleDetails: NewLifestyleDetailsComponent;
	@ViewChild('appNewMedicalDetails')appNewMedicalDetails: NewMedicalDetailsComponent;
	@ViewChild('appNewMedicalEducation')appNewMedicalEducation: NewMedicalEducationComponent;
	@ViewChild('appNewMedicalStatus')appNewMedicalStatus: NewMedicalStatusComponent;
    @ViewChild('appNewMedication')appNewMedication: NewMedicationComponent;
	@ViewChild('appNewPersonalDetails')appNewPersonalDetails: NewPersonalDetailsComponent;
	@ViewChild('appNewPhysicalMeasurements')appNewPhysicalMeasurements: NewPhysicalMeasurementsComponent;
