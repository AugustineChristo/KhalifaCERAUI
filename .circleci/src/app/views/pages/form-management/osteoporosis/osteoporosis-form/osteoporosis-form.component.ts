...
export class OsteoporosisFormComponent implements OnInit {
  ...
  @ViewChild('appParticipation')appParticipation: ObParticipantPersonalComponent;
  @ViewChild('appClinical')appClinical: ObClinicalDetailsComponent;
  @ViewChild('appBiochemical')appBiochemical: ObBiochemicalDetailsComponent;
  @ViewChild('appMedications')appMedications: ObMedicationsComponent;
  @ViewChild('appOneMinuteRiskTest')appOneMinuteRiskTest: ObOneMinuteRiskTestComponent;
  @ViewChild('appFamilyHistory')appFamilyHistory: ObFamilyHistoryComponent;
