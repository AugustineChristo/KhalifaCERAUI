...
@Component({
  ...
  templateUrl: './ob-clinical-details.component.html',
  styleUrls: ['./ob-clinical-details.component.scss'],
  providers: [
...
export class ObClinicalDetailsComponent implements OnInit {
  ...
  createForm() {
    this.form = this.eformFB.group({
      ...
      "CLIN_VerticalTrunkCircumference_CM": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_WHR": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_BodyFatMass_Kg": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_BMIFatPercent": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_BloodPressure_mmHg": new FormControl({value: '', disabled: this.disableInput}),
      ...
      "CLIN_MC_Respiratory": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_MC_Gastrointestinal": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_MC_Others": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_MC_Others_Remarks": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_MC_Fractures": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_MC_FracturesType": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_MC_FracturesDate": new FormControl({value: '', disabled: this.disableInput}),
      "CLIN_MC_DEXAReadings": new FormControl({value: '', disabled: this.disableInput}),
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(7,2).subscribe((res)=> {
