...
@Component({
  ...
  templateUrl: './ob-medications.component.html',
})
export class ObMedicationsComponent implements OnInit {
  ...
  createForm() {
    this.form = this.eformFB.group({
      ...
      "MEDIS_Multivitamins": new FormControl({value: '', disabled: this.disableInput}),
      "MEDIS_Multivitamins_VitaminD": new FormControl({value: '', disabled: this.disableInput}),
      "MEDIS_CalciumSupplements": new FormControl({value: '', disabled: this.disableInput}),
      "MEDIS_CalciumSupplements_Dose": new FormControl({value: '', disabled: this.disableInput}),
      "MEDIS_VitaminD": new FormControl({value: '', disabled: this.disableInput}),
      "MEDIS_VitaminD_Dose": new FormControl({value: '', disabled: this.disableInput}),
      "MEDIS_HormoneReplacementTherapy": new FormControl({value: '', disabled: this.disableInput}),
      "MEDIS_HormoneReplacementTherapy_Remarks": new FormControl({value: '', disabled: this.disableInput}),
    })
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(7,4).subscribe((res)=> {
