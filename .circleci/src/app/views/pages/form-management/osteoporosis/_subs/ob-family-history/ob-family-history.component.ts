...
export class ObFamilyHistoryComponent implements OnInit {
  ...
  createForm() {
    this.form = this.eformFB.group({
      ...
      "FAMH_Osteoporosis": new FormControl({value: '', disabled: this.disableInput}),
      "FAMH_Osteoporosis_complication": new FormControl({value: '', disabled: this.disableInput}),
      "FAMH_Osteoporosis_complication_Remarks": new FormControl({value: '', disabled: this.disableInput}),
      "FAMH_Obesity": new FormControl({value: '', disabled: this.disableInput}),
      "FAMH_BoneFractures": new FormControl({value: '', disabled: this.disableInput}),
      "FAMH_CVD": new FormControl({value: '', disabled: this.disableInput}),
      "FAMH_Other": new FormControl({value: '', disabled: this.disableInput})
    })
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(7,6).subscribe((res)=> {
