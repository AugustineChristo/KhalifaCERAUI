...
export class ObesityCharacteristicsComponent implements OnInit {
  form:FormGroup;
  title:string = "Socioeconomic, Demographic and Behavioural Characteristics";
  ...
  createForm(){
   this.form = this.eformFB.group({
     ...
     "SDBC_SkinColor": new FormControl({value: '', disabled: this.disableInput}),
    "SDBC_Socioeconomic": new FormControl({value: '', disabled: this.disableInput}),
    "SDBC_SmokingStatus": new FormControl({value: '', disabled: this.disableInput}),
    "FOOD_EatFastfood_Week": new FormControl({value: '', disabled: this.disableInput}),
    "FOOD_Fruits_Vegetables_Day": new FormControl({value: '', disabled: this.disableInput}),
    "FOOD_Sodapop_Week": new FormControl({value: '', disabled: this.disableInput}),
    "FOOD_Eat_Midnight": new FormControl({value: '', disabled: this.disableInput}),
    "FOOD_HealthyDiet": new FormControl({value: '', disabled: this.disableInput}),
    "PHYA_Exercise_Week": new FormControl({value: '', disabled: this.disableInput}),
    "PHYA_Satisfy_Body": new FormControl({value: '', disabled: this.disableInput}),
    "PHYA_Happy_Life": new FormControl({value: '', disabled: this.disableInput}),
   });
    this.getFormAttributeValues();
  }
  getFormAttributeValues() {
    this._service.getFormAttribute(6,5).subscribe((res)=> {
