...
export class ObesityPrintComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('appObesityFamilyHistory')appObesityFamilyHistory: ObesityFamilyHistoryComponent;
	@ViewChild('appObesityBiochemical')appObesityBiochemical: ObesityBiochemicalComponent;
  @ViewChild('appObesityPersonalDetails')appObesityPersonalDetails: ObesityPersonalDetailsComponent;
	@ViewChild('appObesityClinicalDetails')appObesityClinicalDetails: ObesityClinicalDetailsComponent;
  @ViewChild('appObesityMedication')appObesityMedication: ObesityMedicationComponent;
	@ViewChild('appObesityCharacteristics')appObesityCharacteristics: ObesityCharacteristicsComponent;
