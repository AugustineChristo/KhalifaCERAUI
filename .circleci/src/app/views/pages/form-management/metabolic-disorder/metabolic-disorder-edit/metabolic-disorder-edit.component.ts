...
export class MetabolicDisorderEditComponent implements OnInit, OnDestroy {
	...
	@ViewChild('appParticipation')appParticipation: ParticipantDetailsComponent;
	@ViewChild('appBiochemical')appBiochemical: BiochemicalComponent;
	@ViewChild('appBiomechanics')appBiomechanics: BiomechanicsDetailsComponent;
	@ViewChild('appClinical')appClinical: ClinicalDetailsComponent;
	@ViewChild('appFamilyHistory')appFamilyHistory: FamilyHistoryDetailsComponent;
	@ViewChild('appFamilyPedigree')appFamilyPedigree: FamilyPedigreeComponent;
	@ViewChild('appLifestyle')appLifestyle: LifestyleDetailsComponent;
	@ViewChild('appMedication')appMedication: MedicationDetailsComponent;
