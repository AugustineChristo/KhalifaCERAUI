...
@Component({
	...
	templateUrl: './metabolic-disorder.component.html'
})
export class MetabolicDisorderComponent implements OnInit {
	// Table fields
	...
	getTotalCount(){
		this._vService.getTotalRecordsCount(1,this.lastQuery.filter).subscribe((res : any[])=>{
			if(res.length > 0)
