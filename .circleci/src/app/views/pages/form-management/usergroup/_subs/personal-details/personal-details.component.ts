...
export class usergroupPersonalDetailsComponent implements OnInit {
 form: FormGroup;
  ...
  ngOnInit() {
    ...
    if (!this.formId)
      this._interactionService._Refid$.subscribe((id) => {
        ...
        this._service.getQuestionnaire(this.formId,17).subscribe((res: any[]) => {
        this.formData = res;
...
this._service.getFormAttribute(17, 1).subscribe((res) => {
...
createSampleId(){
  ...
  this._service.createSampleId(17,this.form.value["name"]).subscribe((res)=> {
      this.saveFormId = res;
      this.splashService.splashScreen({isLoading : false, message : "" })
