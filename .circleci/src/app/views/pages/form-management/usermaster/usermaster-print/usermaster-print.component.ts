...
import { usermasterPersonalDetailsComponent } from '../_subs/personal-details/personal-details.component';


@Component({
  selector: 'kt-usermaster-print',
  templateUrl: './usermaster-print.component.html'
})
export class usermasterPrintComponent implements OnInit,OnDestroy {
