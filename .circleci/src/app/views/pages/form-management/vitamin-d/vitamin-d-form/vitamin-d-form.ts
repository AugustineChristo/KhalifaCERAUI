...
export class VitaminDFormComponent implements OnInit, OnDestroy {
    ...
    @ViewChild('appParticipation')appParticipation: VitaminDParticipationComponent;
    @ViewChild('appClinical')appClinical: VitaminDClinicalDetails;
    @ViewChild('appLifeStyle')appLifeStyle: VitaminDLifeStyles;
    @ViewChild('appFamilyHistory')appFamilyHistory: VitaminDFamilyHistory;
    @ViewChild('appDocUpload')appDocUpload: DocUploadComponent1;
    /**
