...
import { locationsPersonalDetailsComponent } from '../_subs/personal-details/personal-details.component';


@Component({
  selector: 'kt-locations-print',
  templateUrl: './locations-print.component.html'
})
export class locationsPrintComponent implements OnInit,OnDestroy {
  ...
  @ViewChild('applocationsPersonalDetails')applocationsPersonalDetails: locationsPersonalDetailsComponent;
