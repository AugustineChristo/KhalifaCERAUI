...
@Component({
  ...
  templateUrl: './ag-participant-food-intake.component.html',
})
export class AgParticipantFoodIntakeComponent implements OnInit {
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(5,3).subscribe((res)=> {
