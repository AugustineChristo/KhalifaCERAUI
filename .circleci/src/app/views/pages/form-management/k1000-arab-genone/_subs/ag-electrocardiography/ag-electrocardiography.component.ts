...
@Component({
  ...
  templateUrl: './ag-electrocardiography.component.html',
})
export class AgElectrocardiographyComponent implements OnInit {
  ...
  createForm() {
    this.form = this.eformFB.group({
      ...
      "ECXR_AnyECGTestBefore": new FormControl({value: '', disabled: this.disableInput}),
      "ECXR_AnyECGTestBefore_Date": new FormControl({value: '', disabled: this.disableInput}),
      "ECXR_AnyXRayBefore": new FormControl({value: '', disabled: this.disableInput}),
      "ECXR_AnyXRayBefore_Date": new FormControl({value: '', disabled: this.disableInput}),
      "PHYS_IsXRayNormal_PO": new FormControl({value: '', disabled: this.disableInput}),
      "PHYS_IsECGNormal_PO": new FormControl({value: '', disabled: this.disableInput}),
      "PHYS_IsHealthy_PO": new FormControl({value: '', disabled: this.disableInput})
    })
  ...
  getFormAttributeValues() {
    this._service.getFormAttribute(5,8).subscribe((res)=> {
