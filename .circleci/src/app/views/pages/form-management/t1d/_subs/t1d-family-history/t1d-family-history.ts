...
@Component({
    ...
    templateUrl: './t1d-family-history.html'
})

export class T1DFamilyHistory implements OnInit {
    VForm1:FormGroup;
    ...
    createForm() {
        this.VForm1 = this.eformFB.group({
            ...
            "FAMH_T1DFamily"  : new FormControl({value: '', disabled: this.disableInput}), 
            "FAMH_T2DFamily"  : new FormControl({value: '', disabled: this.disableInput}), 
            "FAMH_Diabetescomplication"  : new FormControl({value: '', disabled: this.disableInput}), 
            "FAMH_Diabetescomplication_Remarks"  : new FormControl({value: '', disabled: this.disableInput}), 
            "FAMH_Obesity"  : new FormControl({value: '', disabled: this.disableInput}), 
            "FAMH_Hypertension"  : new FormControl({value: '', disabled: this.disableInput}), 
            "FAMH_Dyslipidaemia"  : new FormControl({value: '', disabled: this.disableInput}), 
            "FAMH_OtherDisease"  : new FormControl({value: '', disabled: this.disableInput}), 
            "FAMH_OtherDisease_Remarks"  : new FormControl({value: '', disabled: this.disableInput}), 
        })
        this.getFormAttributeValues();
    }

    getFormAttributeValues() {
        this._vService.getFormAttribute(8,6).subscribe((res)=> {
