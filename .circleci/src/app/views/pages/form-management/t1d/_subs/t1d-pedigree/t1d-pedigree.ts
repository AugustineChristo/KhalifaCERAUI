...
@Component({
    ...
    templateUrl: './t1d-pedigree.html'
})

export class T1DPedigree implements OnInit {
    VForm1:FormGroup;
    ...
    createForm() {
        this.VForm1 = this.eformFB.group({
            ...
            "FAPD_MemberDiabetes" : new FormControl({value: '', disabled: this.disableInput}),
    ...
    getFormAttributeValues() {
        this._vService.getFormAttribute(8,7).subscribe((res)=> {
