...
export class T1DFormComponent implements OnInit, OnDestroy {
    ...
    @ViewChild('appParticipation')appParticipation: T1DParticipationComponent;
    @ViewChild('appClinical')appClinical: T1DClinicalDetails;
    @ViewChild('appMedication')appMedication: T1DMedication;
    @ViewChild('appLifeStyle')appLifeStyle: T1DLifeStyles;
    @ViewChild('appFamilyHistory')appFamilyHistory: T1DFamilyHistory;
    @ViewChild('appPedigree')appPedigree: T1DPedigree;
    @ViewChild('appBiochemicalDetails')appBiochemicalDetails: T1DBiochemicalDetails;
