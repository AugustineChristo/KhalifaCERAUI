...
import { DiabetesBiochemical2Component } from '../_subs/biochemical2/biochemical2.component';
...
export class DiabetesPrintComponent implements OnInit {
    ...
    @ViewChild('appDiabetesPersonalDetails')appDiabetesPersonalDetails: DiabetesPersonalDetailsComponent;
	@ViewChild('appDiabetesLifeStyleDetails')appDiabetesLifeStyleDetails: DiabetesLifestyleDetailsComponent;
	@ViewChild('appDiabetesFamilyHistory')appDiabetesFamilyHistory: DiabetesFamilyHistoryComponent;
	@ViewChild('appDiabetesFemaleQuestionsComponent')appDiabetesFemaleQuestionsComponent: DiabetesFemaleQuestionsComponent;
	@ViewChild('appDiabetesFamilyPedigree')appDiabetesFamilyPedigree: DiabetesFamilyPedigreeComponent;
	@ViewChild('appDiabetesMedicalDetails')appDiabetesMedicalDetails: DiabetesMedicalDetailsComponent;
	@ViewChild('appDiabetesDiabetesSelfManagement')appDiabetesDiabetesSelfManagement: DiabetesDiabetesSelfManagementComponent;
	@ViewChild('appDiabetesPhysicalMeasurements')appDiabetesPhysicalMeasurements: DiabetesPhysicalMeasurementsComponent;
	@ViewChild('appDiabetesClinicalDetails')appDiabetesClinicalDetails: DiabetesClinicalDetailsComponent;
	@ViewChild('appDiabetesMedicationDetails')appDiabetesMedicationDetails: DiabetesMedicationComponent;
	@ViewChild('appDiabetesBiochemical')appDiabetesBiochemical: DiabetesBiochemicalComponent;
	@ViewChild('appDiabetesBiochemical2')appDiabetesBiochemical2: DiabetesBiochemical2Component;
	@ViewChild('appDiabetesCognitiveTestResult')appDiabetesCognitiveTestResult: DiabetesCognitiveTestResultComponent;
    @ViewChild('appDiabetesLaboratoryDetails')appDiabetesLaboratoryDetails: DiabetesLaboratoryDetailsComponent;
	@ViewChild('appDiabetesMedicalHistoryComponent')appDiabetesMedicalHistoryComponent: DiabetesMedicalHistoryComponent;
	@ViewChild('appDiabetesDietComponent')appDiabetesDietComponent: DiabetesDietComponent;
    @ViewChild('appDiabetesMedication2Component')appDiabetesMedication2Component: DiabetesMedication2Component;
    @ViewChild('appDiabetesMetforminComponent')appDiabetesMetforminComponent: DiabetesMetforminComponent;
	@ViewChild('appDiabetesPhysicalActivityComponent')appDiabetesPhysicalActivityComponent: DiabetesPhysicalActivityComponent;
    @ViewChild('appDiabetesPatientAbsenceComponent')appDiabetesPatientAbsenceComponent: DiabetesPatientAbsenceComponent;
	...
	onSubmit() {
      ...
      this.appDiabetesPersonalDetails.onSubmit();
		...
		this.appDiabetesBiochemical2.onSubmit();
}
