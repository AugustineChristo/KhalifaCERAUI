...
@Component({
  selector: 'kt-diabetes-medication',
  templateUrl: './medication.component.html'
})
export class DiabetesMedicationComponent implements OnInit {
  Mform:FormGroup;
  ...
  createForm() {
    this.Mform = this.eformFB.group({
	  ...
	  "Anti_Hypertensive_Methyldopa": new FormControl({value: '', disabled: this.disableInput}),
	  ...
	  "Oral_agents_Meglitinides_other": new FormControl({value: '', disabled: this.disableInput}),
	  ...
	  "Oral_agents_Dipeptidyl_other": new FormControl({value: '', disabled: this.disableInput}),
	  ...
	  "Oral_agents_Incretin_Other": new FormControl({value: '', disabled: this.disableInput}),
	  ...
	  "Oral_agents_SGLT2_Canagliflozin": new FormControl({value: '', disabled: this.disableInput}),
	  "Oral_agents_SGLT2_Dapagliflozin": new FormControl({value: '', disabled: this.disableInput}),
	  "Oral_agents_SGLT2_Empagliflozin": new FormControl({value: '', disabled: this.disableInput}),
	  "Oral_agents_SGLT2_other": new FormControl({value: '', disabled: this.disableInput}),
	  ...
	  "DTDS_Date": new FormControl({value: '', disabled: this.disableInput}),
	  "DTDS_Date_start": new FormControl({value: '', disabled: this.disableInput}),
	  "DTDS_Date_3month": new FormControl({value: '', disabled: this.disableInput}),
	  "DTDS_Date_6month": new FormControl({value: '', disabled: this.disableInput}),
	  "DTDS_Date_9month": new FormControl({value: '', disabled: this.disableInput}),
	  "DTDS_Date_12month": new FormControl({value: '', disabled: this.disableInput}),
	  ...
	  "DT_Metformin_9month": new FormControl({value: '', disabled: this.disableInput}),
	  "DT_Metformin_12month": new FormControl({value: '', disabled: this.disableInput}),
