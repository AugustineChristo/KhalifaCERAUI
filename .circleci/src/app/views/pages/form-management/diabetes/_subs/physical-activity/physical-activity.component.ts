...
@Component({
  selector: 'kt-diabetes-physical-activity',
  templateUrl: './physical-activity.component.html'
})
export class DiabetesPhysicalActivityComponent implements OnInit {
  form:FormGroup;
  ...
  createForm(){
   this.form = this.eformFB.group({
	  ...
	  "PPA_Yoga": new FormControl({value: '', disabled: this.disableInput}),
