...
export class collectionpointPersonalDetailsComponent implements OnInit {
 form: FormGroup;
  title: string = "Collection Point";
  ...
  ngOnInit() {
    ...
    if (!this.formId)
      this._interactionService._Refid$.subscribe((id) => {
        ...
        this._service.getQuestionnaire(this.formId,16).subscribe((res: any[]) => {
        this.formData = res;
...
this._service.getFormAttribute(16, 1).subscribe((res) => {
...
createSampleId(){
  ...
  this._service.createSampleId(16,this.form.value["name"]).subscribe((res)=> {
      this.saveFormId = res;
      this.splashService.splashScreen({isLoading : false, message : "" })
