...
export class Covid19PersonalDetailsComponent implements OnInit {
 form: FormGroup;
  ...
  createForm() {
    this.form = this.eformFB.group({
      ...
      "COVID19_ID": new FormControl({value : '', disabled : this.disableInput}),
     ...
     "email": new FormControl({value: '', disabled: this.disableInput}),
      ...
      "employment_status": new FormControl({value: '', disabled: this.disableInput}),
       "interpreted_used": new FormControl({value: '', disabled: this.disableInput}),
       "interpreted_language": new FormControl({value: '', disabled: this.disableInput}),
       "interview_reason_contact_with_known_case": new FormControl({value: '', disabled: this.disableInput}),
       "interview_reason_Overseas_travel": new FormControl({value: '', disabled: this.disableInput}),
       "interview_reason_Symptomatic_of_disease": new FormControl({value: '', disabled: this.disableInput}),
       "interview_reason_Reported_recent_risk_exposure_contact": new FormControl({value: '', disabled: this.disableInput}),
       "interview_reason_Occupational_exposure": new FormControl({value: '', disabled: this.disableInput}),
       "interview_reason_other": new FormControl({value: '', disabled: this.disableInput}),
       "interview_reason_other_remarks": new FormControl({value: '', disabled: this.disableInput}),
       "Address": new FormControl({value: '', disabled: this.disableInput}),
       "Address_type": new FormControl({value: '', disabled: this.disableInput}),
       "Address_type_other": new FormControl({value: '', disabled: this.disableInput}),
      "pers_Boys": new FormControl({value: '', disabled: this.disableInput}),
      "pers_Boys_ages": new FormControl({value: '', disabled: this.disableInput}),
      "pers_Girls": new FormControl({value: '', disabled: this.disableInput}),
      "pers_Girls_ages": new FormControl({value: '', disabled: this.disableInput}),
...
this._service.getFormAttribute(11, 1).subscribe((res) => {
...
createSampleId(){
  this.splashService.splashScreen({ isLoading : true, message : "SAVING" })
  this._service.createSampleId(11,this.form.value["sample"]).subscribe((res)=> {
      this.saveFormId = res;
      this.splashService.splashScreen({isLoading : false, message : "" })
