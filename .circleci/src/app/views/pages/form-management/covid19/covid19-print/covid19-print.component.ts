...
export class Covid19PrintComponent implements OnInit,OnDestroy {
  ...
  @ViewChild('appCovid19PersonalDetails')appCovid19PersonalDetails: Covid19PersonalDetailsComponent;
	@ViewChild('appCovid19RiskHistory')appCovid19RiskHistory: Covid19RiskHistoryComponent;
	@ViewChild('appCovid19ClinicalDetails')appCovid19ClinicalDetails: Covid19ClinicalDetailsComponent;
	@ViewChild('appCovid19ClinicalInformation')appCovid19ClinicalInformation: Covid19ClinicalInformationComponent;
	@ViewChild('appCovid19ExposureSites')appCovid19ExposureSites: Covid19ExposureSitesComponent;
	@ViewChild('appCovid19PossibleContacts')appCovid19PossibleContacts: Covid19PossibleContactsComponent;
	@ViewChild('appCovid19LaboratoryDetails')appCovid19LaboratoryDetails: Covid19LaboratoryDetailsComponent;
	@ViewChild('appCovid19Microbiome')appCovid19Microbiome: Covid19MicrobiomeComponent;
